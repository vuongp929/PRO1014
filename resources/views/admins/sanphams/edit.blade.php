                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{ route('sanphams.update', $sanPham->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mt-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $sanPham->ma_san_pham }}" readonly>
                                            ...
                                            <div class="row">
                                                <div class="mt-3">
                                                    ...
                                                    @error('hinh_anh')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                    <img src="{{ Storage::url($sanPham->hinh_anh) }}" alt="hình ảnh" width="100px">
                                                </div>

                                                <div class="mt-3">
                                                    <label for="mo_ta" class="form-label">Mô tả</label>
                                                    <textarea class="form-control" name="mo_ta" id="mo_ta" rows="4">
                                                        {{-- Hiển thị 1 chuỗi có chứa kí tự html --}}
                                                        {!! $sanPham->mo_ta !!}
                                                    </textarea>
                                                </div>
